...
VCR.configure do |config|
  ...
  config.filter_sensitive_data("<API_KEY>") do |interaction|
    interaction.request.headers["Api-Key"].first.to_s if interaction.request.headers["Api-Key"].present?
  end
  config.filter_sensitive_data("<MACHINE_NAME>") do |interaction|
    interaction.request.headers["Machinename"].first.to_s if interaction.request.headers["Machinename"].present?
  end
